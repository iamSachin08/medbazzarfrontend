...
export default function DeliveryAddress (props){
    ...
    return(
        <div style={{display:'flex',width:'45%',border:'solid 1px #00000021',height:'50%',borderRadius:15,padding:10,fontFamily:'kanit',marginTop:40}}>
            <Grid container spacing={2}>
                
                <Grid item xs={12} style={{fontSize:16,fontWeight:'bolder'}}>
                    Dilevery Address
                </Grid>
